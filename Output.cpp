...
Output::Output()
{
	...
	UI.StatusBarHeight = 65;
	UI.ToolBarHeight = 80;
	UI.MenuItemWidth = 80;

	UI.width = 1320; // make it divisible by NumHorizontalCells
	UI.height = 685; 
	UI.wx = 5;
	UI.wy = 5;
...
int Output::GetCellStartX(const CellPosition& cellPos) const
{
	...
	int z = (cellPos.HCell() * UI.CellWidth);
	//(UI.wx) 
...
{
	///TODO: implement the following function as described in Output.h file
	int z = (UI.ToolBarHeight) + (cellPos.VCell() * UI.CellHeight);
	//(UI.wy)
	return z; // this line should be changed with your implementation
}
...
void Output::CreatePlayModeToolBar() const
{
	...
	MenuItemImages[ITM_SWITCH_TO_DESIGN_MODE] = "images\\SWITCH_TO_DESIGN_MODE.jpg";
...
void Output::DrawDiceValue(int DiceValue) const
{
	string DiceValuesImages[6];
	DiceValuesImages[0] = "images\\Dice Values\\Dice1.jpg";
	DiceValuesImages[1] = "images\\Dice Values\\Dice2.jpg";
	DiceValuesImages[2] = "images\\Dice Values\\Dice3.jpg";
	DiceValuesImages[3] = "images\\Dice Values\\Dice4.jpg";
	DiceValuesImages[4] = "images\\Dice Values\\Dice5.jpg";
	DiceValuesImages[5] = "images\\Dice Values\\Dice6.jpg";

	pWind->DrawImage(DiceValuesImages[DiceValue-1], UI.width-UI.StatusBarHeight-5, UI.height-UI.StatusBarHeight, UI.StatusBarHeight-15, UI.StatusBarHeight-15);

}

void Output::DrawPlayerWins(int PlayerNum) const
{
	string PlayersImages[5];
	PlayersImages[0] = "images\\End Game\\Player 0.jpg";
	PlayersImages[1] = "images\\End Game\\Player 1.jpg";
	PlayersImages[2] = "images\\End Game\\Player 2.jpg";
	PlayersImages[3] = "images\\End Game\\Player 3.jpg";
	PlayersImages[4] = "images\\End Game\\GameOver.jpg";

	pWind->DrawImage(PlayersImages[PlayerNum], UI.width - 3 * UI.StatusBarHeight - 5, UI.height - UI.StatusBarHeight, 3 *UI.StatusBarHeight - 30, UI.StatusBarHeight - 10);
