...
class CardTwelve : public Card
{
	...
	static int NumberOf12Cards;
	static int SavedCards;
	static Player* Owner;
public:
	CardTwelve(const CellPosition&); // A Constructor takes card position

	virtual void ReadCardParameters(Grid* pGrid); // Reads the parameters of CardTwelve which is: Price - Fees
