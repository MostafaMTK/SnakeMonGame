...
class CardEleven : public Card
{
	...
	static int NumberOf11Cards;
	static int SavedCards;
	static Player* Owner;
public:
	CardEleven(const CellPosition&); // A Constructor takes card position

	virtual void ReadCardParameters(Grid* pGrid); // Reads the parameters of CardEleven which is: Price - Fees
